    ...
    <main class="admin-main">
        ...
        <div class="password-form-card fadeInDown">
            <div class="text-center mb-4">
                <div class="stat-icon m-auto mb-3" style="width: 70px; height: 70px; background: rgba(52, 152, 219, 0.1);">
            ...
            <form method="POST" action="../admin/pass.php">
                <div class="form-group mb-3">
                    ...
                    <input type="password" id="passwordold" class="form-control" name="passold" placeholder="Nhập mật khẩu hiện tại" required>
                </div>

                <div class="form-group mb-3">
                    <label>Mật khẩu mới</label>
                    <input type="password" id="password1" class="form-control" name="passnew" placeholder="Nhập mật khẩu mới" onkeyup="checkPasswords()" required>
                </div>

                <div class="form-group mb-2">
                    <label>Xác nhận mật khẩu</label>
                    <input type="password" id="password2" class="form-control" name="passnew2" placeholder="Nhập lại mật khẩu mới" onkeyup="checkPasswords()" required>
                </div>
